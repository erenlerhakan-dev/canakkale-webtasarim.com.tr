...
<h6 class="text-white homewelcome2 mb-10">Çanakkale, Türkiye'de lider web geliştirme şirketi <span class="text-line">Modern Teknolojilerle Oluşturulmuş Özel CRM, ERP, E-Ticaret ve Web Uygulamaları</span></h6>
</div>
</div>

<div class="row">
<div class="col-4">
<a class="btn btn--white" href="https://canakkale-webtasarim.com.tr/iletisim.php" style="width: 90%;">İletişim</a>
</div>
<div class="col-4">
<a class="btn btn--secondary" href="https://canakkale-webtasarim.com.tr/hizmetler.php" style="width: 90%;">Hizmetler</a>
</div>
</div>
